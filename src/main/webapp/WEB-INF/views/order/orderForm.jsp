                            ...
                            <form class="form-horizontal" method="post" name="" action="${contextPath}">
                                ...
                                <div class="form-group" id="login-margin">
                                    ...
                                    <div class="input-group" style="margin-bottom:0% ;">
                                        <input type="checkbox"><label for="" style="margin:10px;color:#ededed">회원정보와
                                            동일</label>
                                        <input type="checkbox"><label for="" style="margin:10px;color:#ededed">새로운
                                            배송정보</label>
                                    </div>

                                    <div class="input-group col-mb-3">
                                        <input type="text" class="form-control" width="30px" id="email" name="email"
                                            placeholder="이메일" aria-label="Username">
                                    </div>

                                    <div class="col-m-3">
                                        <input type="password" class="form-control " width="50px" height="30" id="pwd"
                                            name="pwd" maxlength="" placeholder="비밀번호">
                                    </div>

                                    <div class="input-group col-mb-3 " name="name">
                                        <input type="tel" class="form-control" id="name" name="name" aria-label=""
                                            placeholder="이름">
                                    ...
                                    <div class="col-m-3">
                                        <input type="text" class="form-control " width="50px" height="30" id="nick"
                                            name="nick" maxlength="" placeholder="닉네임">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-group d-grid" id="loginbtn">
                                            <button class="btn btn btn-outline-warning" style="color:rgb(255, 255, 253)"
                                                type="button" onclick=" daumZipCode()" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop">우편번호찾기</button>
                                        </div>

                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="주소" id="address1"
                                                name="address1">
                                        </div>
                                        ...
                                        <div class="input-group col-mb-3">
                                            <div class="form-floating">
                                                <textarea class="form-control" style="width: 100%"
                                                    placeholder="Leave a comment here" id="deliveryReq"
                                        ...
                                        <div class="input-group" style="margin-bottom:0% ;">
                                            <input type="checkbox" style="margin-right: 5px;"><label for=""
                                                style="margin:10px;color:#ededed">기본배송지로
                                                저장</label>
                                            <button type="reset"
                                    ...
                                    <div style="width:100%;border-radius: 5%;">
                                        <div class="accordion input-group d-grid" id="accordionPanelsStayOpenExample">
                                                                ...
                                                                <div class="col-12">
                                                                    <table
                                                                        ...
                                                                        <thead class=""
                                                                            ...
                                                                            <tr>
                                                                                <th scope="col" class="alt-font"><input
                                                                                ...
                                                                                <th scope="col" class="alt-font">
                                                                                    products</th>
                                                                                <th scope="col" class="alt-font">price
                                                                                </th>
                                                                                <th scope="col" class="alt-font">
                                                                                    quantity</th>
                                                                                <th scope="col" class="alt-font">total
                                                                                </th>
                                                                                <th scope="col" class="alt-font">choice
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
                                                                            ...
                                                                            <tr>
                                                                                <td scope="col"
                                                                                    class="text-align:center"> <input
                                                                                        ...
                                                                                        aria-label="..."></td>
                                                                                <td scope="col"><a href="#"><img src=""
                                                                                            alt="" width="150"
                                                                                            height="100"></a></td>
                                                                                <td scope="col"><a href="">상품명</a> <br>
                                                                                    상세설명</td>
                                                                                <td scope="col" class="basketprice">
                                                                                    <input type="hidden" name="p_price"
                                                                                        id="p_price1" class="p_price"
                                                                                        value=""></td>
                                                    ...
                                                    <div id="panelsStayOpen-collapseTwo"
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="bg-secondary p-5"
                                                                style="--bs-bg-opacity: .2;border-radius: 5px;">
                                                                <div class="row">
                                                                    <span class="col-1"
                                                                ...
                                                                <div class="row">
                                                                    <span class="col-1">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="50px" viewBox="10 0 576 512">
                                                                ...
                                                                <div class="bg-secondary p-5"
                                                                    ...
                                                                    <div class="row">
                                                                        <span class="col-4"
                                                                            style="font-size:15px;text-align:center;vertical-align:middle;">마이
                                                                            포인트</span>
                                                                        <span class="col-4"
                                                                            style="font-size:15px;text-align:center;vertical-align:middle;">사용
                                                                            포인트</span>
                                                                        <span class="col-4"
                                                                            style="font-size:15px;text-align:center;vertical-align:middle;">남은
                                                                            포인트</span>
                                                                    </div>
                                            ...
                                            <div class="input-group d-grid" id="loginbtn">
                                                <a class="btn btn-outline-warning btn-dark btn-lg"
                                                    type="button">ORDER</a>
                                            </div>
                                            ...
                                            <div class="form-group d-grid" id="loginbtn">
                                                ...
                                                <a class="btn" style="color:aliceblue" type="button"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop"> back to the
                                                    cart</a>
                                            </div>
