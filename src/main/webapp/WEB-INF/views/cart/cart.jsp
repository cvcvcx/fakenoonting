		...
		<div class="container">
			<div class="contents d-flex flex-column mb-2">
				...
				<form action="" class="cart-table">
										...
										<div class="row g-0 justify-content-around">
											<div class="col-1 align-self-center">
												<input class="form-check-input" type="checkbox"
													role="cartItemCheckbox" value="${cartItem.id}" />
											</div>
											...
											<div class="col-4 align-self-center">
												<div class="card-body">
													...
													<p class="card-text mt-2">
														사이즈 : <span id="size_${cartItem.id}">${cartItem.productSize}</span>
													</p>
													<p class="card-text">
														가격 : <span id="resultPrice_${cartItem.id}">${cartItem.productVO.price}
														</span>원<br />( <span id="resultQuantity_${cartItem.id}">${cartItem.productCount}</span>
														개)
													</p>
												</div>
											</div>
											<div class="col-1 align-self-center">
												<div class="card-body">
													<div class="d-flex input-group justify-content-center">
														<input
															style="border: 0 solid black; width: 100%; min-width: max-content; text-align: center;"
															type="text" id="quantity_${cartItem.id}"
															class="form-control align-content-center" size="2"
															maxlength="3" value="${cartItem.productCount}"
											...
											<div class="col-2 align-self-center">
												<div class="btn-group-vertical" role="group"
													...
													<a type="button" class="btn btn-light">order</a> <a
														type="button" role="cancelBtn" value="${cartItem.id}"
					...
					<div class="bg-secondary p-5"
						...
						<div class="row">
							<span class="col-1"
								style="font-size: 25px; text-align: center; vertical-align: middle;">CART</span>
							<span class="col-7"
								style="font-size: 25px; text-align: center; vertical-align: middle;">선택된
								상품 개수</span> <span class="col-4"
								style="font-size: 25px; text-align: center; vertical-align: middle;">총
								가격</span>
						</div>
						<br />
						<div class="row">
							<span class="col-1"> <svg
									xmlns="http://www.w3.org/2000/svg" width="50px"
                    ...
                    <path
							...
							</span> <span id="calculateItemCount" class="col-7"
								style="font-size: 25px; text-align: center; vertical-align: middle;">0개</span>
							<span id="calculateResultPrice" class="col-4"
								style="font-size: 25px; text-align: center; vertical-align: middle;">0원</span>
						</div>
					</div>
				</form>
			</div>
			...
			<div class="d-flex justify-content-center" style="margin-top: 5%">
				<button type="button"
					...
					style="width: 120px; height: 50px">홈으로</button>
				<button type="button"
					class="btn btn-outline-light btn-dark btn-sm ml-2"
					onclick="selectAll(this)" style="width: 120px; height: 50px">
					전체선택</button>
				<button type="button" class="btn btn-outline-light btn-danger ml-2"
					onclick="checkedItemDelete()">선택항목 비우기</button>
				<button type="button"
					class="btn btn-warning btn-outline-light btn-sm btn-sm ml-2"
					style="width: 120px; height: 50px" onclick="fn_buySelectedItem()">
					선택구매</button>
				<button type="button"
					class="btn btn-warning btn-outline-light btn-sm ml-2"
					style="width: 120px; height: 50px">전체구매</button>
			</div>
		</div>
	</div>
...
<script>
	...
	function fn_buySelectedItem() {
		...
		$("input[role='cartItemCheckbox']:checked").each(
				function(index) {
					...
					hiddenInputId.setAttribute("name", "cartItemVOList["
							+ index + "].id");
					...
					hiddenInputSize.setAttribute("name", "cartItemVOList["
							+ index + "].productSize");
					...
					hiddenInputCount.setAttribute("name", "cartItemVOList["
							+ index + "].productCount");
