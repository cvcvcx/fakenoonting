...
#order-margin{
  ...
  <div class="container">
    <div class="contents d-flex align-items-start flex-column mb-2">
      ...
      <!---------------------------------------------------------------------------------------->
      <div class="order-box">
        <form class="form-horizontal" method="post" name="" action="${contextPath}">
          ...
          <div class="form-group" id="login-margin">
            ...
            <div class="input-group" style="margin-bottom:0% ;">
              <input type="checkbox"><label for="" style="margin:10px;color:#ededed">회원정보와 동일</label>
              <input type="checkbox"><label for="" style="margin:10px;color:#ededed">새로운 배송정보</label>
            </div>

            <div class="input-group col-mb-3">
              <input type="text" class="form-control" width="30px" id="email" name="email" placeholder="이메일"
                aria-label="Username">
            </div>

            <div class="col-m-3">
              <input type="password" class="form-control " width="50px" height="30" id="pwd" name="pwd" maxlength=""
                placeholder="비밀번호">
            </div>

            <div class="input-group col-mb-3 " name="name">
              <input type="tel" class="form-control" id="name" name="name" aria-label="" placeholder="이름">
            ...
            <div class="col-m-3">
              <input type="text" class="form-control " width="50px" height="30" id="nick" name="nick" maxlength=""
                placeholder="닉네임">
            </div>

            <div class="input-group col-mb-3" name="phone">
              <select class="form-select" id="phone1" aria-label="Default select example">
              ...
              <input type="tel" class="form-control" id="phone2" placeholder="" aria-label="">
              <span class="input-group-text">-</span>
              <input type="tel" class="form-control" id="phone3" placeholder="" aria-label="">
            </div>
            ...
            <div class="input-group mb-3">
              ...
              <div class="form-group d-grid" id="loginbtn">
                <button class="btn btn btn-outline-warning" style="color:rgb(255, 255, 253)" type="button"
                  onclick=" daumZipCode()" data-bs-toggle="modal" data-bs-target="#staticBackdrop">우편번호찾기</button>
              </div>
              ...
              <div class="input-group col-mb-3">
                <div class="form-floating">
                  <textarea class="form-control" style="width: 100%" placeholder="Leave a comment here" id="address2"
              ...
              <div class="input-group col-mb-3">
                <div class="form-floating">
                  <textarea class="form-control" style="width: 100%" placeholder="Leave a comment here" id="deliveryReq"
                    name="deliveryReq"></textarea>
                  <label for="floatingTextarea">배송요청사항</label>
                </div>
              </div>

              <div class="input-group" style="margin-bottom:0% ;">
                <input type="checkbox" style="margin-right: 5px;"><label for="" style="margin:10px;color:#ededed">기본배송지로
                  저장</label>
                <button type="reset" style="margin-left: 59%;border-radius: 5px;color:#ededed  "
                  class="btn  ">다시작성</button>
              </div>

              <!-------------------------------------------------------------------------------->
              <div style="width:100%;border-radius: 5%;">
                <div class="accordion input-group d-grid" id="accordionPanelsStayOpenExample">
                            ...
                            <div class="col-12">
                              <table
                                ...
                                <thead class="" style="text-align:center ; vertical-align:middle;">
                                  <tr>
                                    <th scope="col" class="alt-font"><input class="form-check-input" type="checkbox" value="selectall"
                                      name="selectall" onclick='selectAll(this)' aria-label="..."> </th>
                                    <th scope="col"></th>
                                ...
                                <tbody style=" text-align:center;vertical-align: middle;">
                                  <tr>
                                    <td scope="col" class="text-align:center"> <input class="form-check-input" type="checkbox"
                                        id="list" name="list" value="" onclick='checkSelectAll()' aria-label="..."></td>
                                    <td scope="col"><a href="#"><img src="" alt="" width="150" height="100"></a></td>
                                    <td scope="col"><a href="">상품명</a> <br> 상세설명</td>
                                    <td scope="col" class="basketprice"><input type="hidden" name="p_price" id="p_price1"
                                        class="p_price" value=""></td>
              
                                    <td scope="col">
              
              
                                      <div class=" d-flex justify-content-center align-items-center">
                                        <div class="row d-flex justify-content-center" id="quantity-checkbox">
              
                                          <input type="number" id="p_num1" name="p_num1" value="1" min="1" max="100"
                                            style="border:5 solid black;width: 80%;height:50px;border-radius: 15%;"
                                    ...
                                    <td scope="col"><label class="" for=""></label></td>
              
                                    <td scope="col">
                                      <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                        <a type="button" class="btn btn-light" href="#">order</a>
                                        <a type="button" class="btn btn-light doCancel" href="javascript:void(0)"
                                          onclick="">cancel</a>
                      ...
                      <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                          <div class="bg-secondary p-5" style="--bs-bg-opacity: .2;border-radius: 5px;">
                            ...
                            <div class="bg-secondary p-5" style="--bs-bg-opacity: .2;border-radius: 5px;">
                              <div class="row">
                                <span class="col-4" style="font-size:15px;text-align:center;vertical-align:middle;">마이
                                  포인트</span>
                                <span class="col-4" style="font-size:15px;text-align:center;vertical-align:middle;">사용
                                  포인트</span>
                                <span class="col-4" style="font-size:15px;text-align:center;vertical-align:middle;">남은
                                  포인트</span>
                              </div>
                              ...
                              <div class="row">
                                <span class="col-4"
                                  style="font-size:25px;text-align:center;vertical-align:middle;">0</span>
                                <span class="col-4"
                                  style="font-size:25px;text-align:center;vertical-align:middle;">0</span>
                                <span class="col-4"
                                  style="font-size:25px;text-align:center;vertical-align:middle;">0</span>
                  ...
                  <div class="input-group d-grid" id="loginbtn">
                    <a class="btn btn-outline-warning btn-dark btn-lg" type="button">ORDER</a>
                  </div>
                  ...
                  <div class="form-group d-grid" id="loginbtn">
                    ...
                    <a class="btn" style="color:aliceblue" type="button" data-bs-toggle="modal"
                      data-bs-target="#staticBackdrop"> back to the cart</a>
                  </div>
