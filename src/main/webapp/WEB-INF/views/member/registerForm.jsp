        ...
        <div class="joinUs-box">
          ...
          >
            <div class="form-group" id="login-margin">
              ...
              <div class="input-group col-mb-3">
                <label class="form-control text-center" for="date">
                  생년월일
                </label>
                <input
                  type="date"
              ...
              >
                <strong>[키커쇼핑몰의 개인 정보 수집 및 이용 안내]</strong> 개인
                정보 제3자 제공 동의 <br />① 개인정보를 제공받는 자: 키커쇼핑몰
                <br />② 개인정보를 제공받는 자의 개인 정보 이용 목적 : 영업관리,
                설문조사 및 프로모션, 이벤트 경품 제공, eDM 발송, 행사 관련
                마케팅 <br />③ 제공하는 개인정보항목 : 이름, 이메일주소, 회사명,
                직무/직책, 연락처, 휴대전화 <br />④ 개인정보를 제공받는 자의
                개인 정보 보유 및 이용 기간 : 개인정보 취급 목적을 달성하여 더
                이상 개인정보가 불 필요하게 된 경우이거나 5년이 지나면 지체 없이
                해당 정보를 파기할 것입니다. <br />귀하는 위와 같은 키커쇼핑몰의
                개인정보 수집 및 이용정책에 동의하지 않을 수 있으나,
                키커쇼핑몰로부터 솔루션, 최신 IT정보, 행사초청안내 등의 유용한
                정보를 제공받지 못 할 수 있습니다. <br />
                개인 정보 보호에 대한 자세한 내용은 http://www.kikerDay.com 을
                참조바랍니다.
                <div class="checkbox" align="center">
                  <label>
                    <input type="checkbox" id="agreement" name="agreement" />
                    kikerDay의 개인정보 수집 및 이용에 동의합니다.
                  </label>
                </div>
              </div>
