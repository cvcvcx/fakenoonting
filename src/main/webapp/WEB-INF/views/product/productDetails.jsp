...
<body>
	...
	<article>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<div id="carouselExampleIndicators" class="carousel slide"
							...
							<div class="carousel-indicators">
								<c:forEach items="${product.productImgItems}" varStatus="status">
									<button type="button"
							...
							<div class="carousel-inner">
								<c:forEach items="${product.productImgItems}" var="imgItem"
									varStatus="status">
									<div
					...
					<div class="col-md-6 text-left">
						...
						<div class="row">
							<div class="col-8 col-md-5">사이즈</div>
							<div class="col-4 col-md-7">
								<select class="form-select" id="size" aria-label="select size">
									<option selected id="notSelected">사이즈를 선택해 주세요.</option>
									<c:forEach items="${product.productSizeList}" var="sizeList">
										<option value="${sizeList.size}">${sizeList.size}
											남은수량 : ${sizeList.productCount} 개</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-4 col-md-7">
								<input class="input-text form-control qty-text" type="number"
									id="productCount" value="1" />
						...
						<div class="row mb-3">
							...
							<div class="col-4 col-md-7">
								<b id="resultPrice">${product.price}</b><span id="resultCount">
									(1개)</span>
							</div>
						</div>
						...
						<div class="row text-center">
							<div class="col-12 col-md-12">
								<div class="d-grid gap-2 mx-auto">
									...
									<!-- Modal -->
									<div class="modal fade" id="selectRequiredOptionModal"
										data-bs-backdrop="static" data-bs-keyboard="false"
										tabindex="-1" aria-labelledby="buyNowLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h1 class="modal-title fs-5" id="buyNowLabel"></h1>
													<button type="button" class="btn-close"
														data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<div class="modal-body">필수 옵션을 선택해주세요.
									...
									<button type="button" class="btn btn-light"
										data-bs-toggle="modal" data-bs-target="#wishButton">
										WISH</button>
									<!-- Modal -->
									<div class="modal fade" id="wishButton"
										data-bs-backdrop="static" data-bs-keyboard="false"
										tabindex="-1" aria-labelledby="wishButtonLabel"
										aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
												...
												<div class="modal-body">관심상품으로 등록되었습니다.</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-primary"
														data-bs-dismiss="modal">
														확인</button>
									...
									<div class="modal fade" id="cartModal"
										data-bs-backdrop="static" data-bs-keyboard="false"
										tabindex="-1" aria-labelledby="cartbuttonLabel"
										aria-hidden="true">
										<div class="modal-dialog modal-xl">
											<div class="modal-content">
												...
												<div class="modal-body">장바구니에 상품이 정상적으로 담겼습니다.</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-light"
														data-bs-dismiss="modal">쇼핑계속하기</button>
		...
		<!-- 리뷰관련 -->
		<section
			class="border-top border-width-1px border-color-medium-gray pt-0">
			<div class="container-fluid">
				<div class="row">
					<div class="col-12">
						<div class="justify-content-center text-center">
							<a class="btn btn-dark btn-sm" href="#reviews" id="reviews">구매후기
								(5)</a> <a class="btn btn-light btn-sm" href="#qanda">상품문의 (2)</a>
						</div>
					</div>
					<hr />
				</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="justify-content-center text-center">
						<a class="btn btn-light btn-sm" href="#reviews">구매후기 (5)</a> <a
							class="btn btn-dark btn-sm" href="#qanda" id="qanda">상품문의 (2)</a>
					</div>
				</div>
				<hr />
			</div>
			...
			$("button[role='cartButton']")
					.on(
							...
							function(e) {
								...
								//필수옵션 선택 체크
								let productSize = $("select[id=size]").val();
								if (productSize == $("option[id=notSelected]")
										.val()) {
									$("#selectRequiredOptionModal").modal(
											'show');
									return;
								}
